...
Skills excluded per registry rules (sdd-* delegate-only, _shared, skill-registry):
...
None found. Scanned: skills/, .opencode/skills/, .claude/skills/, .gemini/skills/, .cursor/skills/, .github/skills/
